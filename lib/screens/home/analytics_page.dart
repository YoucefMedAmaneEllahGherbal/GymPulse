...
class _AnalyticsPageState extends State<AnalyticsPage> {
  ...
  String get _unit => _selectedMetric == 0
      ? 'kcal'
      : _selectedMetric == 1
      ? 'min'
      : 'kg';
  String get _average => _selectedMetric == 0
      ? '646'
      : _selectedMetric == 1
      ? '47'
      : '77.7';
            ...
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color: selected ? kBackgroundColor : kLightAccentColor,
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                '${_metricLabels[_selectedMetric]} recap',
                style: const TextStyle(
                  color: kLightAccentColor,
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
              ...
              DropdownButtonHideUnderline(
                child: DropdownButton<int>(
                  ...
                  onChanged: (value) =>
                      setState(() => _selectedRange = value ?? 0),
                ),
              ),
            ],
          ),
            ...
            child: BarChart(
              BarChartData(
                ...
                gridData: FlGridData(
                  ...
                  horizontalInterval: _selectedMetric == 2 ? 5 : 200,
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: kAccentColor.withValues(alpha: 0.13),
              shape: BoxShape.circle,
            ),
            child: Icon(icon, color: kAccentColor, size: 19),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
